          ...
          <div className="topbar-nav">
            <ul className="flex space-x-6">
              <li className={`rtl:ml-6 ltr:ml-0`}>
                <Link href={userAuth ? "/profile#dashboard" : "/login"}>
                  ...
                  <div className="currencyDropdown">
                    <div className="flex space-x-2 items-center">
                      ...
                      <div className="w-20 relative">
                        ...
                        >
                          <span>{defaultCurrency.currency_icon}</span>
          ...
          <div className="topbar-dropdowns lg:block hidden">
            <div className="flex ltr:space-x-6 rtl:-space-x-0 items-center">
              ...
              <div className="flex ltr:space-x-2 rtl:space-x-0 items-center">
                ...
                <span className="text-xs text-qblack font-500 leading-none">{contact?.email}</span>
              </div>
              <div className="country-select flex space-x-1 items-center">
                ...
                />
                <Selectbox defaultValue="United States" datas={[{ id: 1, name: "United States" }, { id: 2, name: "Bangladesh" }, { id: 3, name: "India" }]} />
                <Arrow className="fill-current qblack" />
              </div>
              <div className="currency-select flex space-x-1 items-center">
                <Selectbox defaultValue="USD" datas={[{ id: 1, name: "USD" }, { id: 2, name: "BDT" }]} />
                <Arrow className="fill-current qblack" />
              </div>
              <div className="language-select flex space-x-1 items-center">
                <Selectbox defaultValue="Bangla" datas={[{ id: 1, name: "Bangla" }, { id: 2, name: "English" }]} />
                <Arrow className="fill-current qblack" />
              </div>
            </div>
          </div>
