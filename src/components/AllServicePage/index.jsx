          ...
          <div className="container-x mx-auto">
            {sellerInfo && (
              ...
              >
                ...
                <div className="saller-name lg:block hidden absolute top-5">
                ...
                <div className="lg:block hidden w-80">
                  ...
                  <p className="text-lg">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed vitae velit non quam consequat hendrerit ac nec nisi.
                  </p>
                  {/* You can add more lines of text as needed */}
                </div>
